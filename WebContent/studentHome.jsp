...
<meta charset="ISO-8859-1">
  ...
  <body>
          ...
          <ul class="navbar-nav ml-auto"> <!-- "ml-auto" consente di allineare item a destra-->
            ...
            <li>
              ...
              <form action="studentHome.jsp" name="studLogout" method="post">
	              <div class="dropdown">
	                <input class="btn btn-outline-success dropdown-toggle" type="button" name="studId" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" value="<%out.println(StudentMainPageController.getStudentMainPageController().getStudInfo().getUsername());%>"/>
    ...
    <div class="container" id="search">
      <h1 align=center><br><br>SEARCH A SEAT</h1>
      <h3 align=center>Enter your address and look for the place to study closest to you:</h3>
      
      		 
      <form class="form-inline my-2 my-lg-0" action="studentHome.jsp" name="studLogout" method="post">
        <input class="form-control ml-auto mr-1" id="searchField" name="searchField" type="text" 
               value="" placeholder="Insert your position...">
        <input class="btn btn-success mr-auto" id="searchBtn" name="searchBtn" type="submit" 
               value="Search">
      </form>
    ...
    <div class="container" id="logo">
      <p><img src="img/logo3.jpg" align=center></p>
    </div>
    </div>
