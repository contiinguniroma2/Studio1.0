  ...
  <body>
    ...
    <div class="row">
      <div class="container" id="search">
        <h1 align=center><br><br>Results:</h1>
      </div>
    </div>


	<form action="studentSearchResult.jsp" name="studentResultList" method="post">
    <div class="row">
				    ...
				    <table id="tableBookings" class="table table-striped table-bordered table-sm" style="text-align: center;" cellspacing="20" width="100%">
					  ...
					  <% 
					  	...
					  	for(int i=0; i<biblioteche.size(); i++){
					        %><tr><td><input class="btn btn-success mx-auto" id="<%out.println(biblioteche.get(i).getName());%>" 
					        role="button" name="bib" type="submit" value="<%out.println(biblioteche.get(i).getName());%>"> </td><td><%out.println(biblioteche.get(i).getCapacity());%></td></tr>
					  	<%  }
					   	%>
