...
public class ListenerDeleteThread implements Runnable {
	private ReportIssueController reportIssueController;
	private boolean running;
	private int port;
	
	public ListenerDeleteThread(ReportIssueController reportIssueController, int port) {
	...
	public void run() {
		...
		try {
	        ...
	        this.reportIssueController.getSessionUser().getReports().remove(newReport);
			}
